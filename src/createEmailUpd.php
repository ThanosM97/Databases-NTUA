...
$next=1;
	...
	while(isset($_POST["email".$next])){
		$sql = "INSERT INTO Hotel_Email_Address (HEmail, Hotel_Hotel_ID , Hotel_Hotel_Group_Hotel_Group_ID) VALUES (?,? ,?)";
		$stmt = $conn->prepare($sql);
		// Bind variables to the prepared statement as parameters
		$stmt->bind_param("sii",$param_email, $hotel_id , $group_id );
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Add emails to hotel: hotel ID= <?php echo $_GET["hotelid"];?> and Group ID =<?php echo $_GET["groupid"];?> .</h2>
                    </div>
                    <p>Please fill this form to add more emails to the hotel with id: <?php echo $_GET["hotelid"]; ?>.</p>
